package com.objectsolutions.polyglot;
...
public class SpeechActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        map.put("Telgu", "te-IN");
        map.put("Tamil", "ta-IN");
        map.put("Kannada", "kn-IN");
        map.put("Malyalam", "ml-IN");
        map.put("Hindi", "hi-IN");
        ...
        mapL.put("Telgu", Language.TELUGU);
        mapL.put("Tamil", Language.TAMIL);
        mapL.put("Kannada", Language.KANNADA);
        mapL.put("Malyalam", Language.MALAYALAM);
